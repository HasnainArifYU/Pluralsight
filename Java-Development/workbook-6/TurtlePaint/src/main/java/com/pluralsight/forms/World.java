 ...
 * Usage example:
 * <pre>
 * com.pluralsight.forms.World basic = new com.pluralsight.forms.World();
 * com.pluralsight.forms.World fancy = new com.pluralsight.forms.World(640, 480, Color.YELLOW);
 *
 * com.pluralsight.forms.Turtle t1 = new com.pluralsight.forms.Turtle(basic);
 * com.pluralsight.forms.Turtle t2 = new com.pluralsight.forms.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new com.pluralsight.forms.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    public World(int width, int height, Color backgroundColor) {
        super("com.pluralsight.forms.Turtle com.pluralsight.forms.World");
    ...
    /**
     * Should only called by the com.pluralsight.forms.Turtle class constructor
     */
    ...
    /**
     * Should only called by com.pluralsight.forms.Turtle class methods
     */
    ...
    /**
     * To be used by com.pluralsight.forms.Turtle class only
